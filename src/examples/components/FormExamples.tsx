...
export default MyForm;`;
  ...
  return (
    <ExampleSection
      ...
      code={code}
      features={['FormProvider', 'Custom Layout', 'Validation', 'Loading States', 'useForm Hook']}
      notes={[
...
const mockUsers: User[] = ${mockDataFormatter(mockUsers.slice(0, 3))};`;
  ...
  return (
    <ExampleSection
      ...
      code={code}
      features={['FormModalProvider', 'Create/Edit Modals', 'State Management', 'CRUD Operations', 'Auto-Generated Forms']}
      notes={[
...
export default ContactForm;`;
  ...
  return (
    <ExampleSection
      ...
      code={code}
      features={['FormProvider + FormModal', 'Complex Layouts', 'Multi-Column Forms', 'Conditional Logic', 'Pre-populated Data']}
      notes={[
...
// Example 4: Auto-Rendered Forms using FormFieldsRenderer pattern
...
export default SurveyForm;`;
  ...
  return (
    <ExampleSection
      ...
      description="Dynamic form rendering using FormFieldsRenderer with field configuration objects"
      code={code}
      features={['FormFieldsRenderer', 'Configuration-Based', 'Multiple Field Types', 'Schema-Driven', 'BadgeSelection']}
      notes={[
...
export default OrderForm;`;
  ...
  return (
    <ExampleSection
      ...
      code={code}
      features={['Card Layouts', 'Conditional Sections', 'Mixed Components', 'Complex Forms', 'FormDropdown']}
      notes={[
